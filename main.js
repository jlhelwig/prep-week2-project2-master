...
pets.unshift('cats');
pets.push   ('dogs');
pets.splice(1,0,"lizards", "horses");
document.getElementById("q1").innerHTML = pets;
...
pets.unshift("snakes");
document.getElementById("q2").innerHTML = pets;
...
pets.splice(1,2)
document.getElementById("q3").innerHTML = pets;
...
pets.splice(2,0,"birds","hamsters")
document.getElementById("q4").innerHTML = pets;
...
"The current length of the array is: " + arraylength;
